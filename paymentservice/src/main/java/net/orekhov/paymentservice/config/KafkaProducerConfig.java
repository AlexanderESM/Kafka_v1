...
/**
 * Конфигурация Kafka для сервиса "Оплата" (Payment Service).
...
public class KafkaProducerConfig {
    ...
    private static final Logger logger = LoggerFactory.getLogger(KafkaProducerConfig.class); // Логгер для класса
